...
//     }, 0);
//     document.querySelector('.cart-sum').innerText = cartSum + 'руб.';
//     return cartSum;
// }
//
...
//             text: `CHECKOUT: ${getCartSum(items)} руб.`,
//             color: '#937e03'
//         });
...
// cartContent(cart);
//
// //Добавить слушатель для добавления продукта
//
...
// });
//
// //Добавить слушатель для удаления продукта
//
